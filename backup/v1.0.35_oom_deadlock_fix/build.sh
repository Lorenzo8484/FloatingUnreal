...
cp "$SRCDIR/$DYLIB" "$PKG/Library/MobileSubstrate/DynamicLibraries/$DYLIB"
cp "$SRCDIR/AFloatingUnreal.plist" "$PKG/Library/MobileSubstrate/DynamicLibraries/AFloatingUnreal.plist"
tar czf "$SRCDIR/$TARBALL" -C "$PKG" .
